 ...
 * RepastS_AgentContext_Cabsf there is a separate CABSF RepastS_SimulationRunContext_CABSF
 * and CABSF RepastS_SimulationRunGroupContext_CABSF, which hold more detailed context
 * information for CABSF simulations.
 * <p/>
 * In general, the individual RepastS agents only need to use the
 * RepastS_AgentContext_Cabsf and simulation-specific helper class. The helper class
 * does utilize RepastS_SimulationRunContext_CABSF and
...
public class RepastS_AgentContext_Cabsf extends AgentContext_Cabsf {
    ...
    /**
     * Gets the CABSF RepastS_SimulationRunContext_CABSF. RepastS_SimulationRunContext_CABSF
     * maintains the state of this specific simulation run.
     *
     ...
     * RepastS_SimulationRunGroupContext_CABSF maintains overall state of all of the
     * simulation runs for this group of simulation runs being executed.
     * Specific simulation run states is stored in RepastS_SimulationRunContext_CABSF
     * instead.
     *
    ...
    public CABSF_SIMULATION_DISTRIBUATION_TYPE initializeRepastSagentForCabsf(
        ...
        if (!setBypassRepastSruntimeForTesting && repastS_SimulationRunContext_CABSF == null) {
