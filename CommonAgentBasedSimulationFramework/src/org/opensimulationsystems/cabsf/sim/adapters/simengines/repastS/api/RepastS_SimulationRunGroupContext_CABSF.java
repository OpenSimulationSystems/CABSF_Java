 ...
 * @since 0.1
 */
public class RepastS_SimulationRunGroupContext_CABSF {
     ...
     *            the simulation run group context
     */
    public RepastS_SimulationRunGroupContext_CABSF(
            final SimulationRunGroupContext simulationRunGroupContext) {
        this.simulationRunGroupContext = simulationRunGroupContext;
    }

    // TODO: This can probably be removed now that we've added the abstract
    // AgentContext_Cabsf
    /**
