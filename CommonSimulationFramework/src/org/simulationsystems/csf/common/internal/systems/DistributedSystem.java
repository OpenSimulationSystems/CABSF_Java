...
public class DistributedSystem {
	 ...
	 * to the common messaging system. If the flag is set to true and the distributedAgentUUIDs is
	 * empty, only the flag is passed to the common messaging system/distributed system. It is
