...
public class HumanJADE extends Agent {
	...
	protected void setup() {
		...
		// agents. Gives the user access to many convience methods for dealing with XML
		...
		distributedAutonomousAgentModelID = getAID().getLocalName();
	...
	private class HumanJADE_Server extends CyclicBehaviour {
		...
		public void action() {
			...
			if (aclMsg != null) {
				...
				String originalMessageId = aclMsg.getReplyWith();
				...
				//jade_Controller_Agent
				//		.receiveMessage(msg, newMessageID, originalMessageId);
