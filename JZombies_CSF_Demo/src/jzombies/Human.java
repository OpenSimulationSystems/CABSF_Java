...
public class Human {
	...
	public void run() {
		...
		if (CSF_ON && simulationType == SIMULATION_TYPE.CSF_SIMULATION) {
		...
		// Back to common code for Repast
			...
			// else make the decision here, not using the distributed agent.
