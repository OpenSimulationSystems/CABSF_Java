...
public class PlayerJADE extends Agent {
    ...
    private class PrisonersDilemmaJADE_Server extends CyclicBehaviour {
        ...
        public void action() {
            ...
            if (aclMsg != null) {
                ...
                final int round =
                        prisonersDilemma_CABSF_Helper.getRoundNumber(
                ...
                final DECISION myDecision =
                        makeDecision(round, otherPlayerLastRoundDecision);
                System.out.println(logPrefix + " Decided: " + myDecision.toString());

                FrameworkMessage replyMsg =
                ...
                distributedAutonomousAgentElement =
                        replyMsg.getNextDistributedAutonomousAgent(
                                replyMsg.getDocument(), jade_MAS_AgentContext
                ...
                // Get the agent model actor and set the ID
                agentModelActor =
                        replyMsg.getNextAgentModelActor(
                                distributedAutonomousAgentElement,
    ...
    protected void setup() {
         ...
         */
        prisonersDilemma_CABSF_Helper =
                new PrisonersDilemma_CABSF_Helper(jade_MAS_AgentContext);
