...
public class PlayerJADE extends Agent {
	...
	private class PrisonersDilemmaJADE_Server extends CyclicBehaviour {
		...
		/**
		 * The method called to determine whether the Player should COOPERATE or DEFECT
		 * for a given round. JADE agent authors should use this method to store the
		 * decision history of their opponent and to make the new decision.
		 *
		 * @param round
		 *            the round
