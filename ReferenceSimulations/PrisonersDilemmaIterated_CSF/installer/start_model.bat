@ECHO OFF
TITLE PrisonersDilemmaIterated_CSF
...
CD PrisonersDilemmaIterated_CSF

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./PrisonersDilemmaIterated_CSF.rs
