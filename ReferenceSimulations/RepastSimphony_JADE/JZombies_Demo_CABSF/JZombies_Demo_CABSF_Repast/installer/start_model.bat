@ECHO OFF
TITLE JZombies_Demo_CABSF_Repast
...
CD JZombies_Demo_CABSF_Repast

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./JZombies_Demo_CABSF_Repast.rs
