...
public class JZombiesBuilder implements ContextBuilder<Object> {
    ...
    public Context build(final Context<Object> context) {
        ...
        final NetworkBuilder<Object> netBuilder =
                new NetworkBuilder<Object>("infection network", context, true);
        netBuilder.buildNetwork();

        final ContinuousSpaceFactory spaceFactory =
        ...
        final int zombieCount =
                (Integer) params.getValue("zombie_count");
        for (int i =
                0; i < zombieCount; i++) {
        ...
        final int humanCount =
                (Integer) params.getValue("human_count");
        for (int i =
                0; i < humanCount; i++) {
            final int energy =
                    RandomHelper.nextIntFromTo(4, 10);
        ...
        // Prefer to handle maximum simualtion runs using Cabsf configuration.
        // However, it can be hard coded here.
        /*
