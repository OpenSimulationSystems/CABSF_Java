...
public class XMLTests implements JadeControllerInterface {
    static private XMLTests instance =
            new XMLTests();
    ...
    public static void setUpBeforeClass() throws Exception {
        cabsfRepastS_AgentContext =
                new CabsfRepastS_AgentContext();
        cabsfRepastS_AgentContext.setBypassRepastRuntimeForTestingPurposes(true);
        cabsfRepastS_AgentContext.initializeCabsfAgent(null, null);

        final JADE_MAS_AdapterAPI jade_MAS_AdapterAPI =
        ...
        jade_MAS_RunContext =
                new JADE_MAS_RunContext(null);

        jZombies_CABSF_Helper =
                new JZombies_CABSF_Helper(cabsfRepastS_AgentContext);
        ...
        try {
            simulationRunGroupContext =
                    simulationAPI.initializeAPI("TEMP", simToolNameToSetInSimulationAPI);
    ...
    String xmlString =
            "<DistributedAutonomousAgent xmlns=\"http://www.opensimulationsystems.org/cabsf/schemas/CabsfMessageExchange/0.1.0\"\r\n"
    ...
    FrameworkMessage testPopulatePrisonersDilemmaMessageHelper() {
        ...
        final Element distributedAutonomousAgentElement =
                msg.getNextDistributedAutonomousAgent(msg.getDocument(),
                        simulationRunGroupContext
        ...
        final Element agentModelActor =
                msg.getNextAgentModelActor(distributedAutonomousAgentElement,
        ...
        final int round =
                1;
        final DECISION otherPlayerLastDecision =
                DECISION.COOPERATE;
    ...
    public void testPopulateZombiesMessage() {
        ...
        List<String> thisAgentModelPosition =
                new ArrayList<String>();
        thisAgentModelPosition.add("1");
        thisAgentModelPosition.add("2");
        List<String> pointLeastZombies =
                new ArrayList<String>();
    ...
    public void testReadZombiesAndSelfLocations() {
        Element distributedAutonomousAgentElement =
                null;
        try {
            distributedAutonomousAgentElement =
                    XMLUtilities.xmlStringTojdom2Document(xmlString).getRootElement();
    ...
    public void testReceiveMessageInJADEAgent() {
        final NativeDistributedAutonomousAgent nativeDistributedAutonomousAgent =
                new MockHumanJADE_Agent("DistSys1", "DistributedSystemAutonomousAgent1",
        ...
        try {
            ...
            final Element distributedAutonomousAgentElement =
                    XMLUtilities.xmlStringTojdom2Document(xmlString).getRootElement();
            final FrameworkMessage msg =
                    jade_MAS_AgentContext.convertDocumentToSendToDAAtoFrameworkMessage(
                            distributedAutonomousAgentElement,
    ...
    public void testReceiveMessageInPrisonersDilemmaJADEagent() {
        ...
        final DECISION decision =
                prisonersDilemma_CABSF_Helper.getOtherPlayerDecision(
                        distributedAutonomousAgent, msg);
        System.out.println("Read decision: " + decision.toString());

        final int roundNumber =
                prisonersDilemma_CABSF_Helper.getRoundNumber(distributedAutonomousAgent,
                        msg);
