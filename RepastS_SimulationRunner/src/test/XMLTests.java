...
public class XMLTests implements JadeControllerInterface {
    ...
    public void testReadZombiesAndSelfLocations() {
        ...
        try {
            ...
            agentModelId = distributedAutonomousAgentElement.getChild("ID", namespace)
                    .getValue();
        ...
        msg.addSoftwareAgent(msg.getDocument(),
    ...
    public void testReceiveMessageInJADEAgent() {
        final NativeSoftwareAgent nativeSoftwareAgent = new MockHumanJADE_Agent(
        ...
        try {
            ...
            final FrameworkMessage msg = jade_MAS_AgentContext
                    .convertDocumentToSendToSoftwareAgentToFrameworkMessage(
                            distributedAutonomousAgentElement,
                            distributedAutonomousAgentID, SYSTEM_TYPE.SIMULATION_RUNTIME,
                            SYSTEM_TYPE.DISTRIBUTED_SYSTEM);
            nativeSoftwareAgent.receiveMessage(msg, messageID, null, this);
