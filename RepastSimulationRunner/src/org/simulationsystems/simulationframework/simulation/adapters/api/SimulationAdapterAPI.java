 ...
 * RepastSimphonySimulationAdapterAPI(s) --> Simulations and Agents (Such as
 ...
 * both an RepastSimphonySimulationAdapterAPI into the common simulation
 * framework and its own application programmatically running Repast as a
 * library.<br/>
 * <br/>
 * 
 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;JADE - Via the
...
public class SimulationAdapterAPI {
	...
	public static SimulationAdapterAPI getInstance() {
		if (simulationAdapterInitializationHelper==null)
			simulationAdapterInitializationHelper = new SimulationAdapterInitializationHelper(instance);
		return instance;
	}
	 ...
	 * called for each type. This is done prior to the distributed agent-side
	 * mappings.
	 * 
	 * Use this method to send an Iterable collection of Agents, all members a
	 * particular class.
	 * 
	 * @see mapSimulationSideAgent
	 */
	public void mapSimulationSideAgents(Class item,
			Iterable<Object> agentsOfOneType) {
