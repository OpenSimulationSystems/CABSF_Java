...
public class SimulationDistributedAgentManager {
	...
	public SimulationDistributedAgentManager(SimulationRunContext simulationRunContext, String simulationDistributedAgentMessagingManagerStr) {
		this.simulationRunContext = simulationRunContext;
		
		//Instantiate the correct manager for the common messaging interface (e.g., Redis or web services) using reflection.
		...
		try {
			...
			//simulationDistributedAgentMessagingManager = (SimulationDistributedAgentMessagingManager) cons.newInstance();
			simulationDistributedAgentMessagingManager = (SimulationDistributedAgentMessagingManager) cl.newInstance();
