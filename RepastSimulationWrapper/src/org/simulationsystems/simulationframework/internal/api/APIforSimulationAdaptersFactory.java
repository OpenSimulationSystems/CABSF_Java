 ...
 */
public class APIforSimulationAdaptersFactory {
	private static APIforSimulationAdaptersFactory instance = new APIforSimulationAdaptersFactory();

	// Disabled
	private APIforSimulationAdaptersFactory() {
	}

	/**
	 * 
	 * The API Factory for clients that are simulation systems adapters to into
	 * the common simulation framework
	 * 
	 */
	public static APIforSimulationAdaptersFactory getInstance() {
		return instance;
	}
