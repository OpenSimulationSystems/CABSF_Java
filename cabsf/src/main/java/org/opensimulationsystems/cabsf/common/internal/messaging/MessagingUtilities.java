...
public class MessagingUtilities {
    ...
    /**
     * Creates the cached message exchange template JDOM2 Document. Any
     * placeholder values in the template file are kept in the returned
     * Document.
     *
     ...
     */
    static public org.jdom2.Document createCachedMessageExchangeTemplate()
            throws JDOMException, IOException {
        Document doc = null;
        doc = XMLUtilities
                .filenameStrTojdom2Document(
                        "org/opensimulationsystems/cabsf/common/resources/messageexchange/CabsfMessageTemplate.xml",
                        true);
