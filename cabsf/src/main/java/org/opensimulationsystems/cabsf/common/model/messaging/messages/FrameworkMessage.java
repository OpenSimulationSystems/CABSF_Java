 ...
 * (CabsfMessage). This interface contains several convenience methods
...
public interface FrameworkMessage {
    ...
    /**
     * Adds the distributed autonomous agent to a CabsfMessage Document.
     ...
     * @return the document
     */
    public Document addSoftwareAgent(Document CabsfMessageDoc,
     ...
     */
    List<Element> getDistributedSoftwareAgentElements(Object CabsfMessageDoc);
    ...
    /**
     * Gets the CabsfMessage XML Document which thie FrameworkMessage
     * wraps.
     *
     * @return the document
     */
    ...
    /**
     * Gets the next distributed autonomous agent in the CabsfMessage
     ...
     */
    List<String> getAgentModelGridCellLocation(
            Element softwareAgentElement, FrameworkMessage msg);
    ...
    // always going to
    // be populated?
    Element populateThisLocationGridCellInAgentModelActor(Element actor, String gridPointX,
     ...
     *            the cabsf message exchange doc
     */
    public void removeDistributedSoftwareAgentElements(Document CabsfMessageDoc);
