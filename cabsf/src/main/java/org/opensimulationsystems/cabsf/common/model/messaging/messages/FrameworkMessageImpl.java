...
public class FrameworkMessageImpl implements FrameworkMessage {
     ...
     */
    @Override
    public Document addSoftwareAgent(final Document CabsfMessageDoc,
        ...
        return frameworkMessageDocumentHelper.addDistributedAutonomousAgent(
                CabsfMessageDoc, distributedAutononomousAgentElement, removeChildren);
    }
    ...
    public Element getNextNonSelfSimulationDefinedLocationForActor(final Element actor,
        ...
        return frameworkMessageDocumentHelper
                .getNextNonSelfSimulationSpecifiedLocationGridCellForActor(actor,
     ...
     */
    @Override
    public String getSoftwareAgentID(final Element distributedAutononomousAgentElement) {
        return frameworkMessageDocumentHelper
     ...
     */
    @Override
    public Element populateThisLocationGridCellInAgentModelActor(final Element actor,
            final String gridPointX, final String gridPointY,
            final Element cachedLocationTemplate) {
        return frameworkMessageDocumentHelper
                .populateThisActorLocationGridCellInAgentModel(actor, gridPointX,
                        gridPointY, cachedLocationTemplate);
    }
     ...
     */
    @Override
    public void removeDistributedSoftwareAgentElements(final Document CabsfMessageDoc) {
        frameworkMessageDocumentHelper.removeSoftwareAgentElements(CabsfMessageDoc);
