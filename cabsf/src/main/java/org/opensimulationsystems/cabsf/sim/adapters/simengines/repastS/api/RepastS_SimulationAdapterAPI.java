...
public class RepastS_SimulationAdapterAPI {
    ...
    public DefaultParameters applyRssrParametersFix(final Controller controller,
        ...
        for (int i = 0; i < parameterElements.size(); i++) {
            ...
            if (defaultValue.equals("__NULL__")) {
                defaultParameters.addParameter(paramName, displayName, Number.class, num,
                        true);
    ...
    public RepastS_SimulationRunContext_CABSF initializeSimulationRun(
        ...
        repastS_SimulationRunContext_CABSF.getSimulationDistributedSystemManagers()
        ...
        final Class simulationAgentClass : simulationAgentsClasses) {
            ...
            if (repastS_SimulationRunContext_CABSF
    ...
    private boolean shouldApplypParametersFix(final String cabsfConfigurationDocumentStr)
        ...
        final Filter<Element> elementFilter = new org.jdom2.filter.ElementFilter();
        /** The namespace str. */
        final String namespaceStr = "http://www.opensimulationsystems.org/cabsf/schemas/CabsfMessage/0.2";
